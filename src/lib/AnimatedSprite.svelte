...
<script lang="ts">
  ...
  export let sortableChildren: PIXI.AnimatedSprite['sortableChildren'] =
    undefined
  export let interactiveChildren: PIXI.AnimatedSprite['interactiveChildren'] =
    undefined

  // DisplayObject props
  export let accessible: PIXI.AnimatedSprite['accessible'] = undefined
  export let accessibleChildren: PIXI.AnimatedSprite['accessibleChildren'] =
    true
