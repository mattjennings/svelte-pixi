<script lang="ts">
  ...
  onMount(() => {
    ...
    const handleEvent = (type) => (ev: PIXI.FederatedEvent) => {
      dispatch(type, ev)
    }

    instance.onclick = handleEvent('click')
    instance.onglobalmousemove = handleEvent('globalmousemove')
    instance.onglobalpointermove = handleEvent('globalpointermove')
    instance.onglobaltouchmove = handleEvent('globaltouchmove')
    instance.onmousedown = handleEvent('mousedown')
    instance.onmousemove = handleEvent('mousemove')
    instance.onmouseout = handleEvent('mouseout')
    instance.onmouseover = handleEvent('mouseover')
    instance.onmouseup = handleEvent('mouseup')
    instance.onmouseupoutside = handleEvent('mouseupoutside')
    instance.onmouseupoutside = handleEvent('mouseupoutside')
    instance.onpointercancel = handleEvent('pointercancel')
    instance.onpointerdown = handleEvent('pointerdown')
    instance.onpointermove = handleEvent('pointermove')
    instance.onpointerout = handleEvent('pointerout')
    instance.onpointerover = handleEvent('pointerover')
    instance.onpointertap = handleEvent('pointertap')
    instance.onpointerup = handleEvent('pointerup')
    instance.onpointerupoutside = handleEvent('pointerupoutside')
    instance.onrightclick = handleEvent('rightclick')
    instance.onrightdown = handleEvent('rightdown')
    instance.onrightup = handleEvent('rightup')
    instance.onrightupoutside = handleEvent('rightupoutside')
    instance.ontap = handleEvent('tap')
    instance.ontouchcancel = handleEvent('touchcancel')
    instance.ontouchend = handleEvent('touchend')
    instance.ontouchendoutside = handleEvent('touchendoutside')
    instance.ontouchmove = handleEvent('touchmove')
    instance.ontouchstart = handleEvent('touchstart')
