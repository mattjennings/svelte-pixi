...
- Rewritten for Svelte 5
  - Svelte 4 components are still available from `svelte-pixi/svelte-4`. [Read more](/getting-started/svelte-5)
- [PerspectiveMesh](/api/components/perspective-mesh) component
- [Application `stage` snippt/slot](http://localhost:4321/api/components/application#custom-stage)
