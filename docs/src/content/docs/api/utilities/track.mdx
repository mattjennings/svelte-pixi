...
<Aside>
  `track` has been deprecated and replaced by [tick](/api/utilities/tick)
</Aside>
...
It can also be used to [bind props](/guides/binding-props), as SveltePixi components don't support `bind:` syntax for instance properties.
