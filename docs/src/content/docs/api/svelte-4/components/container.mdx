...
<script>
  import { Container, Sprite, onTick, getApp } from 'svelte-pixi'
...
>
  <!-- 
    ...
    if you have thousands of objects, it's usually better to 
    create pixi objects yourself and add them to the container
    instance manually
  -->
