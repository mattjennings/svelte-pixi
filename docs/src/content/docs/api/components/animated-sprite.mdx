...
<ComponentDescription name="AnimatedSprite" source="https://pixijs.download/dev/docs/scene.AnimatedSprite.html" />
...
<script>
  ...
  import { AnimatedSprite } from 'svelte-pixi/svelte-5'
</script>
