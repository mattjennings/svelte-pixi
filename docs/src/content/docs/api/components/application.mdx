...
<Application width={720} height={450} antialias>
  <Text
    x={360}
    y={225}
    anchor={0.5}
...
<Application width={720} height={400} antialias>
...
<script>
  ...
  import DraggableCircle from './_DraggableCircle.svelte'
